...
--
-- Host: 127.0.0.1    Database: bromall
-- ------------------------------------------------------
...
CREATE TABLE `user_admin_login_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=52 DEFAULT CHARSET=utf8 COMMENT='后台用户登录日志表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `user_admin_login_log`
--

LOCK TABLES `user_admin_login_log` WRITE;
/*!40000 ALTER TABLE `user_admin_login_log` DISABLE KEYS */;
INSERT INTO `user_admin_login_log` VALUES (5,3,'2018-12-06 13:59:12','0:0:0:0:0:0:0:1',NULL,NULL),(6,3,'2018-12-17 13:23:20','0:0:0:0:0:0:0:1',NULL,NULL),(7,3,'2018-12-18 13:51:42','0:0:0:0:0:0:0:1',NULL,NULL),(8,3,'2018-12-18 13:51:51','0:0:0:0:0:0:0:1',NULL,NULL),(9,3,'2019-01-28 16:20:41','0:0:0:0:0:0:0:1',NULL,NULL),(10,3,'2019-01-29 09:16:25','0:0:0:0:0:0:0:1',NULL,NULL),(11,3,'2019-01-29 10:10:51','0:0:0:0:0:0:0:1',NULL,NULL),(12,3,'2019-02-18 11:03:06','0:0:0:0:0:0:0:1',NULL,NULL),(13,3,'2019-03-12 10:03:55','0:0:0:0:0:0:0:1',NULL,NULL),(14,3,'2019-03-12 10:06:19','0:0:0:0:0:0:0:1',NULL,NULL),(15,3,'2019-03-12 10:15:22','0:0:0:0:0:0:0:1',NULL,NULL),(16,3,'2019-03-20 15:35:33','0:0:0:0:0:0:0:1',NULL,NULL),(17,3,'2019-03-20 15:38:50','0:0:0:0:0:0:0:1',NULL,NULL),(18,3,'2019-12-01 13:03:01','127.0.0.1',NULL,NULL),(19,3,'2019-12-01 13:48:25','127.0.0.1',NULL,NULL),(20,3,'2019-12-01 13:51:11','127.0.0.1',NULL,NULL),(21,3,'2019-12-01 13:54:39','127.0.0.1',NULL,NULL),(22,3,'2019-12-01 13:55:29','127.0.0.1',NULL,NULL),(23,3,'2019-12-01 15:08:43','127.0.0.1',NULL,NULL),(24,3,'2019-12-01 16:00:03','127.0.0.1',NULL,NULL),(25,3,'2019-12-01 16:00:32','127.0.0.1',NULL,NULL),(26,3,'2019-12-01 16:01:51','127.0.0.1',NULL,NULL),(27,3,'2019-12-01 16:06:36','127.0.0.1',NULL,NULL),(28,3,'2019-12-01 16:09:57','127.0.0.1',NULL,NULL),(29,3,'2019-12-01 17:55:09','127.0.0.1',NULL,NULL),(30,3,'2019-12-01 17:56:07','127.0.0.1',NULL,NULL),(31,3,'2019-12-01 18:07:30','127.0.0.1',NULL,NULL),(32,3,'2019-12-01 18:09:08','127.0.0.1',NULL,NULL),(33,3,'2019-12-01 21:47:50','127.0.0.1',NULL,NULL),(34,3,'2019-12-01 22:11:27','127.0.0.1',NULL,NULL),(35,3,'2019-12-01 22:18:12','127.0.0.1',NULL,NULL),(36,3,'2019-12-01 22:21:51','127.0.0.1',NULL,NULL),(37,3,'2019-12-01 22:44:41','127.0.0.1',NULL,NULL),(38,3,'2019-12-01 22:48:02','127.0.0.1',NULL,NULL),(39,3,'2019-12-01 23:12:05','127.0.0.1',NULL,NULL),(40,3,'2019-12-02 09:15:02','127.0.0.1',NULL,NULL),(41,3,'2019-12-02 09:17:17','127.0.0.1',NULL,NULL),(42,3,'2019-12-02 09:19:51','127.0.0.1',NULL,NULL),(43,3,'2019-12-02 09:28:22','127.0.0.1',NULL,NULL),(44,3,'2019-12-02 09:57:39','127.0.0.1',NULL,NULL),(45,3,'2019-12-02 09:59:16','127.0.0.1',NULL,NULL),(46,3,'2019-12-02 10:02:38','127.0.0.1',NULL,NULL),(47,3,'2019-12-02 10:45:47','127.0.0.1',NULL,NULL),(48,3,'2019-12-02 10:46:38','127.0.0.1',NULL,NULL),(49,3,'2019-12-02 10:47:20','127.0.0.1',NULL,NULL),(50,3,'2019-12-02 11:59:56','127.0.0.1',NULL,NULL),(51,3,'2019-12-02 12:48:51','127.0.0.1',NULL,NULL);
/*!40000 ALTER TABLE `user_admin_login_log` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `user_admin_permission_relation`
--
...
--
-- Dumping data for table `user_admin_permission_relation`
--

LOCK TABLES `user_admin_permission_relation` WRITE;
/*!40000 ALTER TABLE `user_admin_permission_relation` DISABLE KEYS */;
/*!40000 ALTER TABLE `user_admin_permission_relation` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `user_admin_role_relation`
--
...
--
-- Dumping data for table `user_admin_role_relation`
--

LOCK TABLES `user_admin_role_relation` WRITE;
/*!40000 ALTER TABLE `user_admin_role_relation` DISABLE KEYS */;
INSERT INTO `user_admin_role_relation` VALUES (13,3,1),(15,3,2),(16,3,4);
/*!40000 ALTER TABLE `user_admin_role_relation` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `user_growth_change_history`
--

DROP TABLE IF EXISTS `user_growth_change_history`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `user_growth_change_history` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `member_id` bigint(20) DEFAULT NULL,
  `create_time` datetime DEFAULT NULL,
...
--
-- Dumping data for table `user_growth_change_history`
--

LOCK TABLES `user_growth_change_history` WRITE;
/*!40000 ALTER TABLE `user_growth_change_history` DISABLE KEYS */;
INSERT INTO `user_growth_change_history` VALUES (1,1,'2018-08-29 17:16:35',0,1000,'test','测试使用',1);
/*!40000 ALTER TABLE `user_growth_change_history` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `user_integration_change_history`
--

DROP TABLE IF EXISTS `user_integration_change_history`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `user_integration_change_history` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `member_id` bigint(20) DEFAULT NULL,
  `create_time` datetime DEFAULT NULL,
  `change_type` int(1) DEFAULT NULL COMMENT '改变类型：0->增加；1->减少',
...
--
-- Dumping data for table `user_integration_change_history`
--

LOCK TABLES `user_integration_change_history` WRITE;
/*!40000 ALTER TABLE `user_integration_change_history` DISABLE KEYS */;
/*!40000 ALTER TABLE `user_integration_change_history` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `user_integration_consume_setting`
--

DROP TABLE IF EXISTS `user_integration_consume_setting`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `user_integration_consume_setting` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `user_integration_consume_setting`
--

LOCK TABLES `user_integration_consume_setting` WRITE;
/*!40000 ALTER TABLE `user_integration_consume_setting` DISABLE KEYS */;
INSERT INTO `user_integration_consume_setting` VALUES (1,100,50,100,1);
/*!40000 ALTER TABLE `user_integration_consume_setting` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `user_member_level`
--

LOCK TABLES `user_member_level` WRITE;
/*!40000 ALTER TABLE `user_member_level` DISABLE KEYS */;
INSERT INTO `user_member_level` VALUES (1,'黄金会员',1000,0,199.00,5,1,1,1,1,1,1,NULL),(2,'白金会员',5000,0,99.00,10,1,1,1,1,1,1,NULL),(3,'钻石会员',15000,0,69.00,15,1,1,1,1,1,1,NULL),(4,'普通会员',1,1,199.00,20,1,1,1,1,0,0,NULL);
/*!40000 ALTER TABLE `user_member_level` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `user_member_login_log`
--
...
--
-- Dumping data for table `user_member_login_log`
--

LOCK TABLES `user_member_login_log` WRITE;
/*!40000 ALTER TABLE `user_member_login_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `user_member_login_log` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `user_member_member_tag_relation`
--

DROP TABLE IF EXISTS `user_member_member_tag_relation`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `user_member_member_tag_relation` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `member_id` bigint(20) DEFAULT NULL,
...
--
-- Dumping data for table `user_member_member_tag_relation`
--

LOCK TABLES `user_member_member_tag_relation` WRITE;
/*!40000 ALTER TABLE `user_member_member_tag_relation` DISABLE KEYS */;
/*!40000 ALTER TABLE `user_member_member_tag_relation` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `user_member_product_category_relation`
--

DROP TABLE IF EXISTS `user_member_product_category_relation`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `user_member_product_category_relation` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `member_id` bigint(20) DEFAULT NULL,
  `product_category_id` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
--
-- Dumping data for table `user_member_product_category_relation`
--

LOCK TABLES `user_member_product_category_relation` WRITE;
/*!40000 ALTER TABLE `user_member_product_category_relation` DISABLE KEYS */;
/*!40000 ALTER TABLE `user_member_product_category_relation` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `user_member_receive_address`
--

DROP TABLE IF EXISTS `user_member_receive_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `user_member_receive_address` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `member_id` bigint(20) DEFAULT NULL,
...
--
-- Dumping data for table `user_member_receive_address`
--

LOCK TABLES `user_member_receive_address` WRITE;
/*!40000 ALTER TABLE `user_member_receive_address` DISABLE KEYS */;
INSERT INTO `user_member_receive_address` VALUES (1,1,'大梨','18033441849',0,'518000','广东省','深圳市','南山区','科兴科学园'),(3,1,'大梨','18033441849',0,'518000','广东省','深圳市','福田区','清水河街道'),(4,1,'大梨','18033441849',1,'518000','广东省','深圳市','福田区','东晓街道');
/*!40000 ALTER TABLE `user_member_receive_address` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `user_member_rule_setting`
--

DROP TABLE IF EXISTS `user_member_rule_setting`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `user_member_rule_setting` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `user_member_rule_setting`
--

LOCK TABLES `user_member_rule_setting` WRITE;
/*!40000 ALTER TABLE `user_member_rule_setting` DISABLE KEYS */;
/*!40000 ALTER TABLE `user_member_rule_setting` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `user_member_statistics_info`
--

DROP TABLE IF EXISTS `user_member_statistics_info`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `user_member_statistics_info` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `member_id` bigint(20) DEFAULT NULL,
...
--
-- Dumping data for table `user_member_statistics_info`
--

LOCK TABLES `user_member_statistics_info` WRITE;
/*!40000 ALTER TABLE `user_member_statistics_info` DISABLE KEYS */;
/*!40000 ALTER TABLE `user_member_statistics_info` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `user_role` VALUES (1,'商品管理员','商品管理员',0,'2018-09-30 15:46:11',1,0),(2,'商品分类管理员','商品分类管理员',0,'2018-09-30 15:53:45',1,0),(3,'商品类型管理员','商品类型管理员',0,'2018-09-30 15:53:56',1,0),(4,'品牌管理员','品牌管理员',0,'2018-09-30 15:54:12',1,0);
...
--
-- Dumping data for table `user_role_permission_relation`
--

LOCK TABLES `user_role_permission_relation` WRITE;
/*!40000 ALTER TABLE `user_role_permission_relation` DISABLE KEYS */;
INSERT INTO `user_role_permission_relation` VALUES (1,1,1),(2,1,2),(3,1,3),(4,1,7),(5,1,8),(6,2,4),(7,2,9),(8,2,10),(9,2,11),(10,3,5),(11,3,12),(12,3,13),(13,3,14),(14,4,6),(15,4,15),(16,4,16),(17,4,17);
/*!40000 ALTER TABLE `user_role_permission_relation` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-12-02 12:52:10
